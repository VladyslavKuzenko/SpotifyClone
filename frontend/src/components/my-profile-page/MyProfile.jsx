...
const MyProfile = ({ profileInfo }) => {
  ...
  const [followings, setFollowings] = useState(userFullInfo.followings);
  const [followers, setFollowers] = useState(userFullInfo.followers);
  ...
  useEffect(()=>{
    ...
    setFollowers(userFullInfo.followers)
    setFollowings(userFullInfo.followings)
  },[userFullInfo])
            ...
            <div className={styles["tab-content"]}>
              ...
              {activeTab1 === "artistTools" && (
                <ArtistOwnMediaLibrary
                  userToShowProfile={userFullInfo}
